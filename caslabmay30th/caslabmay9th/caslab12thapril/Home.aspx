<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="caslab12thapril.Inbox" %>
...
<body>
							...
							<div style="background-color:lavender;" class="container-fluid">
								<div class="row">
									...
									<button type="button" class="btn btn-primary active"><a style="color:white;" href="WebForm1.aspx">Home</a>   </button>
										...
										<button type="button" class="btn btn-primary"><a  style="color:white;" href="Home.aspx" >View</a>  </button>
    ...
    padding-left: 2px" class="col-lg-2 one" >
										...
										<div class="list-group  " aria-expanded="true"  >
											<asp:DropDownList runat="server" ID="idproject" DataSourceID="Sqldatasource1" DataTextField="ProjectId" DataValueField="ProjectId" OnSelectedIndexChanged="project_SelectedIndexChanged" AppendDataBoundItems="true"  AutoPostBack="true"  class="list-group-item">
            ...
            <tr>
                ...
                <td> <asp:DropDownList runat="server" ID="taskids" DataSourceID="SqlDataSource2" DataTextField="TaskId" DataValueField="TaskId" AutoPostBack="true" AppendDataBoundItems="true" class="list-group-item" OnSelectedIndexChanged="taskids_SelectedIndexChanged"></asp:DropDownList>
...
<%--                                          <div class="form-group">
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:MatreyPharmaConnectionString %>" SelectCommand="proc_GetProjectDetailsByEmpid1" SelectCommandType="StoredProcedure">
                                            <SelectParameters>
                                                <asp:SessionParameter Name="EmpId" SessionField="Session[&quot;EmpId&quot;]" Type="String" />
                                            </SelectParameters>
                                        </asp:SqlDataSource>
