...
{
    public partial class ViewPage1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                String strQuery = "select Name from AddnewTask2 where EmpId=@EmpId";
        ...
        protected void taskids_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            String strQuery = " select Name,TaskName,TaskDescription,Chemical,Quantity,Units from AddnewTask2";

            SqlConnection con = new SqlConnection(str);
            SqlCommand cmd = new SqlCommand();
            //cmd.Parameters.AddWithValue("@Name", taskids.SelectedItem.Value);
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = strQuery;
            cmd.Connection = con;
            Panel1.Visible = true;
            ...
            try
            {
                ...
                while (sdr.Read())
                {
                    ...
                    Label14.Text = sdr.GetValue(5).ToString();
